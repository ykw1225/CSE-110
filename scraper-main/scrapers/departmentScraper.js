...
exports.getDepartments = function(callback, request) {
    ...
    request(url, function(error, response) {
        ...
        for(var dep of body["departments"]) {
            ...
            } else if(dep.code != "JUDA" && dep.code != "LTIT" && dep.code != "GERM" && dep.code != "RELI" && dep.code != "RUSS" && dep.code != "UNAF"){
                departments.push([dep.code, dep.name, [dep.code]]);
            }
        }
        departments.push(["RSM", "Rady School of Management", ["RSM", "MGT", "MGTF"]]);
